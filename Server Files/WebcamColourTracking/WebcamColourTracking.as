package {
	...
	public class WebcamColourTracking extends Sprite
	{
		...
		private var colour:Number = 0xFFFFFF;
		...
		private function startMe(e:MouseEvent):void {
			...
			this.stage.addEventListener(MouseEvent.MOUSE_UP, stageClicked); 
		}
		...
		private function updateStage(e:Event):void {
			...
			myData = new URLRequest("http://localhost/test.php");
			
			
			variables.pagenumber = F.toString();
			variables.under_line=uline;
			variables.xpos=rect.x;
			variables.ypos=rect.y;
			...
			square2.graphics.lineStyle(3,0xFF0000);
				...
				square2.graphics.drawCircle(rect.x,rect.y,0.5);
